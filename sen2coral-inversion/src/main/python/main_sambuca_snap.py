...
class main_sambuca:
    ...
    def main_sambuca_func(self,observed_rrs,observed_rrs_width, observed_rrs_height, sensor_xml_path, siop_xml_path, par_xml_path, above_rrs_flag, shallow_flag, error_name, opt_met):
    ...
    #pool=None
        result_recorder=output_calculation.output_calculation(observed_rrs, objective, siop,
                                                                        result_recorder, image_info, opt_met, shallow = shallow_flag)
        ...
        return depth, sdi, kd, error_f, r_sub, sub1_frac, sub2_frac, sub3_frac