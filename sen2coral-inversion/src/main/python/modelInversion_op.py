...
class modelInversionOp:
    ...
    def initialize(self, context):
        ...
        # Retrieve a parameters defined in modelInversion_op-info.xml
        ...
        # into an other class
        self.algo = modelInversion_algo.modelInversionAlgo(NDVI_LOW_THRESHOLD, NDVI_HIGH_THRESHOLD)
